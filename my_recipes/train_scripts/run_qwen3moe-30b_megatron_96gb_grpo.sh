...
project_name='Verl'
exp_name='Qwen3-30b-MATH-megatron'
...
infer_ppo_micro_batch_size_per_gpu=8
# Paths
MODEL_PATH=/opt/users/ye/checkpoints/Qwen3-30B-A3B-Base-general_202w_concat_domain_70w_function_call_31w_total_303w-ep3
# /opt/users/models/Qwen3-30B-A3B
...
# TRAIN_FILE=/mnt/code/yehangcheng/verl/examples/data_preprocess/gsm8k/train.parquet
# TEST_FILE=/mnt/code/yehangcheng/verl/examples/data_preprocess/gsm8k/test.parquet
...
nohup python3 -m verl.trainer.main_ppo --config-path=./config --config-name='ppo_megatron_trainer'\
    ...
    > /mnt/code/yehangcheng/verl/Qwen3-30B-A3B-Base-general_202w_concat_domain_70w_function_call_31w_total_303w-ep3.log 2>&1 &
