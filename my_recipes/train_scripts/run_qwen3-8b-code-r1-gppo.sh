...
project_name=DAPO
exp_name=DAPO_Qwen3_8B_Base_sft_202w_concat_lmsys_278w_24k_math_step_480_IF_step_600_code_rl_livecodebench
CKPTS_DIR=/mnt/code/yehangcheng/verl/checkpoints/${project_name}/${exp_name}
TRAIN_FILE=/opt/users/ye/data/deepcoder/split/deepcoder_train_modified_livecodebench.parquet
...
nohup python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode=gppo \
    ...
    trainer.total_epochs=100 $@ > /mnt/code/yehangcheng/verl/Qwen3_8B_Base_sft_202w_concat_lmsys_278w_24k_math_step_480_IF_step_600_code_rl_livecodebench.log 2>&1 &