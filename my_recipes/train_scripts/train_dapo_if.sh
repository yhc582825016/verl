...
MODEL_PATH=/opt/users/models/Qwen3-4B-Instruct-2507
CKPTS_DIR=/mnt/code/yehangcheng/verl/checkpoints/${project_name}/${exp_name}
TRAIN_FILE=/mnt/code/yehangcheng/verl/recipe/insturct_following/rl_dataset_train.parquet
TEST_FILE=/mnt/code/yehangcheng/verl/recipe/insturct_following/ifeval_test.parquet
...
nohup python3 -m verl.trainer.main_ppo \
    ...
    > /mnt/code/yehangcheng/verl/recipe/insturct_following/Qwen3-4B-Instruct-2507-instruction_following-dapo.log 2>&1 &
